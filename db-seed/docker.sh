...
aws ecs run-task \
 ...
 --network-configuration "awsvpcConfiguration={subnet-010440914faaebfe9,subnet-09380cca9f715e298],securityGroups=[sg-0f622a86be90ceb4a],assignPublicIp=DISABLED}" \
