...
aws ecs run-task \
 ...
 --network-configuration "awsvpcConfiguration={subnets=[subnet-0500deee72b1bbf42,subnet-06ad4669c236ce937],securityGroups=[sg-0e15ae3f2820b670a],assignPublicIp=DISABLED}" \
