...
aws ecs run-task \
 ...
 --network-configuration "awsvpcConfiguration={subnets=[subnet-0fae82aca27e094ec,subnet-0cd6120e9362b7ce2],securityGroups=[sg-0dfd8df623e5ba643],assignPublicIp=DISABLED}" \
